    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs"><span class="mr-2"><a href="/">Home</a></span> <span>Change Password</span></p>
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="old_password" type="password" value="" class="form-control" placeholder="">
                                @error('old_password')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="new_password" type="password" value="" class="form-control" placeholder="">
                                @error('new_password')
                                <div class="note-help-block">{{ $message }}</div>
                                @enderror
                            </div>
