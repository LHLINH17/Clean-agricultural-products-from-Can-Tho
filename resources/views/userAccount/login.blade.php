...
<head>
    ...
    <link rel="stylesheet" href="/template/users/css/style.css">
...
<div class="login-box" style="margin: 30px 500px; width: 350px">
    <!-- /.login-logo -->
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="../../index2.html" class="h1"><b>Login Account</b></a>
        </div>
        <div class="card-body">
            <p class="login-box-msg" style="text-align: center">Welcome to nongsancantho</p>

            <form action="" method="post">
                @csrf
                <div class="input-group mb-3" style="border-radius: 3px">
            ...
            <div style="line-height: 10px;">
                <p class="mb-1">
                <div>
                    <a href="{{ route('forgot_password') }}">You forgot your password?</a>
                </div>
                </p>

                <p class="mb-0">
                    <a href="/users/register" class="text-center">Register an account</a>
                </p>
            </div>
