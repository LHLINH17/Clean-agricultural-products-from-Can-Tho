    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs">
                    <span class="mr-2"><a href="/">Home/</a>
                    </span> <span class="mr-2"><a
                                href="/danh-muc/{{ $products->menu->id }}-{{ \Str::slug($products->menu->name) }}.html">{{ $products->menu->name }}/</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate">
                <a href="{{ $products->thumb }}" class="image-popup"><img src="{{ $products->thumb }}" class="img-fluid"
            ...
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <p class="price">
                    <span>
                         {{ number_format($products->price_sale != 0 ? $products->price_sale : $products->price)}} VND
{{--                        {{ number_format($product->price )}} VND--}}
                ...
                <div class="row mt-4">
                    ...
                    {{--                    @if(auth('cus')->check())--}}
                    <div class="col-md-12">
                        <p style="color: #000;">{{ $products->quantity }} kg available</p>
                    </div>
                </div>
                ...
                <a title="Thêm vào giỏ hàng" href="{{ route('cart.add', $products->id ) }}" class="">
...
{{--                            <a class="pull-right">--}}
{{--                                <img src="/template/user/images/userIcon.png" width="30px" class="media-oject">--}}
{{--                            </a>--}}
{{--                            &nbsp;--}}
{{--                            <div class="media-body">--}}
{{--                                @if(auth('cus')->check())--}}
{{--                                    <h6 class="media-heading" style="font-size: 18px">Me--}}
{{--                                        <small style="font-size: 11px">({{date($comment->created_at)}})</small>--}}
{{--                                    </h6>--}}
{{--                                    <p>Comment: {{$comment->comment}}</p>--}}
{{--                                @else--}}
{{--                                    <h6 class="media-heading" style="font-size: 18px">{{$comment->customerName->name}}--}}
{{--                                        <small style="font-size: 11px">({{date($comment->created_at)}})</small>--}}
{{--                                    </h6>--}}
{{--                                    <p style="width: 500px">Comment: {{$comment->comment}} </p>--}}
{{--                                @endif--}}

{{--                                @if($comment->customer_id == auth('cus')->id())--}}
{{--                                    <p class="text-left">--}}
{{--                                        <a href="/users/comment/delete/{{$comment->product_id}}/{{$comment->id}}"--}}
