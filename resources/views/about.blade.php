...
<div class="hero-wrap hero-bread" style="background-image: url('/template/users/images/bg_1.jpg');">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">Welcome to Nongsansachcantho an eCommerce website</h2>
                    </div>
                </div>
                <div class="pb-md-5">
                ...
                <div class="row">
                    <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
                        <div class="block-18 text-center">
                            <div class="text">
                                <strong class="number" data-number="9434">0</strong>
